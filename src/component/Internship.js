      ...
      <div className="container">
        <div className="row">
          <div className="col-12">
            ...
            <br />
            <div className="row">
              <motion.div className="col-sm-5 tw-bg-blue-900 tw-rounded-xl tw-p-2" initial={{y:100,opacity:-4}} whileInView={{y:0 , opacity:1}} transition={{ease:"easeIn", duration:0.6}} >
                <div className="mt-3">
